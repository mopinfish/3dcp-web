...
const Map3D = () => {
  ...
  useEffect(() => {
    ...
    // rekichizuのスタイルを読み込む
    fetch('https://mierune.github.io/rekichizu-style/styles/street/style.json')
      .then((response) => response.json())
      .then((rekichizuStyle: maplibregl.StyleSpecification) => {
        // PLATEAUの定義を追加
        rekichizuStyle.sources.plateau = {
          type: 'vector',
          tiles: [
        ...
        styles.rekichizu = rekichizuStyle
